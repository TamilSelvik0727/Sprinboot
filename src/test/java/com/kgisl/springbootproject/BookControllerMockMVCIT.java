...
import com.kgisl.springbootproject.controller.BookController;
import com.kgisl.springbootproject.entity.Book;
import com.kgisl.springbootproject.service.BookService;
...
public class BookControllerMockMVCIT {
    ...
    public void update() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/api/books/" + id).contentType(MediaType.APPLICATION_JSON)
                .content(asJsonString(book2))).andExpect(status().isOk());
    }
    ...
    public void postmapping() throws Exception {
        ...
        mockMvc.perform(post("/api/books/").contentType(MediaType.APPLICATION_JSON).content(asJsonString(book1)))
